...
namespace Persistence.Configurations
{
    public sealed class UserConfiguration : IEntityTypeConfiguration<User>
    {
        public void Configure(EntityTypeBuilder<User> builder)
        {
            ...
            builder.Property<byte[]>(user => user.PasswordHash)
               .IsRequired();

            builder.Property<byte[]>(user => user.PasswordSalt)
               .IsRequired();

            builder.Property(user => user.SubscriptionId);

            builder.Property(user => user.PaymentId);
